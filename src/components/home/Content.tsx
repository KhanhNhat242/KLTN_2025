...
const [startProvince, setStartProvince] = useState<Province | null>(null);
const [endProvince, setEndProvince] = useState<Province | null>(null);
 useEffect(() => {
   axios
     .get(
